...
public class PlayerManager : Singleton<PlayerManager>
{
    ...
    public static bool isLocalP(ushort id) => id == LocalPlayer.Id;
    ...
    {
        LocalPlayer.name = $"{LocalPlayer.name} -- {LocalPlayer.Id} -- LOCAl";
    }
    #region Messages

    /* ------------------------- MESSAGE RECIEVE ------------------------- */
    [MessageHandler((ushort)ServerToClientMSG.ApproveLogin)]
    private static void RecievingMessageLogin(Message msg)
    {
